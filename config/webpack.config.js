...
const bizChartsConfig = require('./bizcharts.config.js');
...
const redVars = getLessVars('./node_modules/oss-ui/lib/style/themes/red.less');

const themeConfig = {
    stylesDir: path.join(__dirname, '../src'),
    ossUiDir: path.join(__dirname, '../node_modules/oss-ui'),
    varFile: path.join(__dirname, '../node_modules/oss-ui/lib/style/themes/darkblue.less'),
    themeVariables: Array.from(
        new Set([
            ...Object.keys(defaultVars),
            ...Object.keys(darkblueVars),
...
const TopoImgWebpackPlugin = require('topo-img-webpack-plugin');
...
module.exports = function (webpackEnv) {
                ...
                },
                {
                    ...
                    options: {
                        ...
                        lessOptions: {
                            ...
                            modifyVars: getThemeVariables({ darkblue: true }),
                            // modifyVars: getThemeVariables({ red: true, compact: true }),
    ...
    return {
                    ...
                    oneOf: [
                        ...
                        // A missing `test` is equivalent to a match.
                        {
                            ...
                            options: {
                                limit: imageInlineSizeLimit,
                                name: 'static/media/[name].[hash:8].[ext]',
                                // publicPath: process.env.NODE_ENV === 'production' ? 'http://localhost:42002' : '',
                                // publicPath: process.env.NODE_ENV === 'production' ? 'http://10.206.161.170:8086' : '',
                                // publicPath: process.env.NODE_ENV === 'production' ? 'http://10.10.2.8:9003' : '',
                            },
                        },
                        {
                            test: [/\.ttf$/i, /\.otf$/i],
        ...
        plugins: [
            ...
            NPM_CONFIG_FlAG === 'true' && new BundleAnalyzerPlugin(),
            // isEnvProduction && new UpdatePopup({ inject: false }),
